          ...
          >
            <Box className="link-item">
              <Box
                ...
                sx={{
                  display:
                    currentPath.pathname === NAVBAR_LINKS.home.link
                      ? "flex"
                      : "none",
                }}
              />
              <Link
                href={NAVBAR_LINKS.home.link}
                underline="none"
                sx={{
                  color:
                    currentPath.pathname === NAVBAR_LINKS.home.link
            ...
            <Box className="link-item">
              <Box
                ...
                sx={{
                  display:
                    currentPath.pathname === NAVBAR_LINKS.domains.link
                      ? "flex"
                      : "none",
                }}
              />
              <Link
                href={NAVBAR_LINKS.domains.link}
                underline="none"
                sx={{
                  color:
                    currentPath.pathname === NAVBAR_LINKS.domains.link
